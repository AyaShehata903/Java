...
public class SmileDemoEDA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        trainData = testData.merge (IntVector.of ("Gender", encodeCategory (testData, "Sex")));
        trainData = testData.merge (IntVector.of ("PClassValues", encodeCategory (testData, "Pclass")));
        ...
        int[][] testResult = model.test(testData);
